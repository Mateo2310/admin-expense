...
public class UserMapper {
    public static User toDomainUser(UserEntity userEntity) {
        ...
        return new User(userEntity.getId(), userEntity.getName(), userEntity.getUsername(), userEntity.getLastname(), role, userEntity.getCreatedAt(), new Date());
    }

    public static UserEntity toUserEntity(User user) {
        RoleEntity roleEntity = RoleMapper.toRoleEntity(user.getRole());
        return new UserEntity(user.getId(), user.getName(), user.getUsername(), user.getLastname(), roleEntity, user.getCreatedAt(), new Date());
    }
}
