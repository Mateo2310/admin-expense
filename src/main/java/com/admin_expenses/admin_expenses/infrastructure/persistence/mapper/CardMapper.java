...
public class CardMapper {
    public static Card toDomainCard(CardEntity cardEntity) {
        ...
        return new Card(cardEntity.getCardType(), finantialInstituteDomain, cardEntity.getAlias(), userDomain, cardEntity.getCreatedAt(), cardEntity.getUpdatedAt());
    }
    ...
    public static CardEntity toCardEntity(Card card) {
        ...
        return new CardEntity(card.getCardType(), finantialInstituteEntity, card.getAlias(), finantialInstituteEntity.getCreatedAt(), finantialInstituteEntity.getUpdatedAt(), userEntity);
    }
}
