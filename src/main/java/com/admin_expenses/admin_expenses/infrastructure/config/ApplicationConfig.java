...
public class ApplicationConfig {
    ...
    private final UserDetailsService userDetailsService; // tu implementación de UserDetailsService
    private final PasswordEncoder passwordEncoder;       // tu encoder, normalmente BCrypt
